...
/*   Updated: 2025/03/22 03:46:47 by sslaoui          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : name(""), Hit_point(100), Energy_point(100), Attack_damage(30)
{
	std::cout << "ClapTrap created" << std::endl;
}

ClapTrap::ClapTrap(std::string src) : name(src), Hit_point(100), Energy_point(100), Attack_damage(30)
{
	std::cout << "ClapTrap created" << std::endl;
}
